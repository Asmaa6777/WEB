...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const profileNameDisplay = document.getElementById('profileNameDisplay'); // Matches your new <h2>
    ...
    if (profileNameDisplay) profileNameDisplay.textContent = displayName; // Update new Admin-style header
    ...
    profileForm.addEventListener('submit', (e) => {
        ...
        const finalName = currentUser.name || currentUser.username;
        ...
        if (profileNameDisplay) profileNameDisplay.textContent = finalName; // Sync header on save
